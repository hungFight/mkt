...
const FormPostByPageId: FC<{
  ...
  return (
    <div>
      ...
      />
      <div className="my-2 ">
        <h2 className="text-blue-500">{t('config_scan_post')}</h2>
        <div className="border rounded-[10px] p-2">
          ...
          <InputField
            ...
            inputClassName="focus:border-blue-400"
          />
          {RenderInputNumber({
            register,
            formDT,
      ...
      <div className="my-2">
        ...
        <div className="border rounded-[10px] p-2 flex items-center">
