...
const ModalConfirm: FC<{
  ...
  titleRightB: string
  icon: ReactElement
  onClick: (is: boolean | 'exist') => void
}> = ({ title, classBox, classRoot, classTitle, titleLeftB, titleRightB, onClick, icon }) => {
  const { t } = useTranslation()
  return (
    <>
      {/* <button onClick={onClick}>Open Delete Modal</button> */}
      <div
        id="deleteModal"
        aria-hidden="true"
