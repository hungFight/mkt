...
import userProfile from '@renderer/assets/images/user.png'
...
const Header = (): JSX.Element => {
  ...
  const [isShowModalRules, setIsShowModalRules] = useState(false)
  ...
  const openModalRules = (): void => {
    setIsShowModalRules(true)
  }

  const openModalNotification = (): void => {
  ...
  return (
    <header className={themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}>
      <div className="shadow-sm">
        <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
          ...
          <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 justify-end lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
            ...
            <ToolTips content="Thông báo">
              <button onClick={openModalNotification} className="bg-[#E3E8EF] p-[4px] rounded-full">
            ...
            <div
              className=" border-white-light bg-[#E3E8EF] dark:border-white-light/10 flex rounded-full p-2 cursor-pointer hover:bg-[#4361ee1a] hover:text-[#4361ee]"
              onMouseEnter={() => setIsHovered(true)}
              onMouseLeave={() => setIsHovered(false)}
              onClick={handleOpenSettings}
            >
              <ToolTips content="Cài đặt">
                <svg
            ...
            <div className="dropdown shrink-0 flex items-center">
              <Dropdown
                offset={[0, 8]}
                  ...
                  <li>
                    <div className="flex items-center px-4 py-4">
                      ...
                      <div className="ltr:pl-4 rtl:pr-4 truncate">
                        ...
                        <button
                          type="button"
                          className="text-black/60 !pl-0 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                        >
                          huytq@phanmemmkt.vn
                        </button>
                      </div>
      ...
      <ReactJoyride
        ...
        disableOverlayClose
      />
      {isShowModalRules && <ModalTerm isShow={isShowModalRules} setIsShow={setIsShowModalRules} />}
      {isShowModalNotification && (
        <ModalNotification
          isShow={isShowModalNotification}
          setIsShow={setIsShowModalNotification}
        />
      )}
    </header>
  )
