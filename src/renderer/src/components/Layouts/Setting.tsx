  ...
  return (
    <div>
      ...
      <nav
        ...
        } bg-white fixed ltr:-right-[50%] rtl:-left-[50%] tab-setting top-0 bottom-0 w-full max-w-[50%] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] dark:bg-black p-4`}
      >
