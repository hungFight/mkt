  ...
  return (
    <div>
      ...
      <nav
        ...
        } bg-white fixed ltr:-right-[500px] rtl:-left-[500px] tab-setting top-0 bottom-0 w-full max-w-[500px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] dark:bg-black p-4`}
      >
