          ...
          >
            ...
            <div className="flex items-center justify-between z-10">
              <div className="flex items-center justify-between">
                <button
                  type="button"
                  className="shadow-[0_0_2px_0_#bfc9d4] rounded p-1 text-white-light hover:bg-[#1937cc] place-content-center ltr:mr-2 rtl:ml-2"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
                ...
                <button
                  type="button"
                  className="shadow-[0_0_2px_0_#bfc9d4] rounded p-1 text-white-light hover:bg-[#1937cc] grid place-content-center"
                >
                  <svg
                    width="20"
                    height="20"
              ...
              <button
                type="button"
                className="shadow-[0_0_2px_0_#bfc9d4] rounded p-1 text-white-light hover:bg-[#4361ee] z-10"
              >
                Upgrade
              </button>
            </div>
              ...
              <div className="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                <div className="flex items-center">
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="text-info inline ltr:mr-1.5 rtl:ml-1.5 relative -top-1"
                  >
                    <path
                ...
                <button
                  type="button"
                  className="flex items-center bg-success/30 text-success rounded-md px-1.5 py-1 text-xs hover:shadow-[0_10px_20px_-10px] hover:shadow-success"
                >
                  Read More
                  <svg
                    width="24"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-4 h-4 rtl:rotate-180 ltr:ml-1.5 rtl:mr-1.5"
                  >
                    <path
                      d="M11 19L17 12L11 5"
                      stroke="currentColor"
          ...
          <div className="panel h-full">
            ...
            <div className="group">
              <div className="text-white-dark mb-5">
                ...
                commodi. Nesciunt quas aut neque incidunt!
              </div>
