      ...
      <div className="pt-5">
        ...
        <div className="space-y-5 mt-5">
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black ">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 1 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 1 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 2 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 2 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 3 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 3 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 4 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 4 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 5 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 5 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black">
            <div
              className={`flex font-semibold p-5 rounded-t-md  cursor-pointer ${
                active === 6 ? 'bg-primary/20 text-primary' : ''
              }`}
            ...
            >
              ...
              <div className="ltr:ml-auto  rtl:mr-auto flex">
                <svg
                  className={`w-5 h-5 ${active === 6 ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
