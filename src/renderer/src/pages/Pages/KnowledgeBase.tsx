      ...
      <div className="pt-5">
        ...
        <form action="" method="" className="mb-5">
          <div className="relative max-w-[580px] mx-auto">
            ...
            <button
              type="button"
              className="btn btn-primary absolute top-1 ltr:right-1 rtl:left-1 shadow-none"
            >
              Search
            </button>
          </div>
        </form>
        <p className="text-base mb-14 text-center font-semibold">
        ...
        <div className="space-y-5 mb-10">
          <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-black ">
            <div
              className={`flex font-semibold p-5 cursor-pointer ${
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5 ltr:mr-4 rtl:ml-4 shrink-0"
              >
                <path
