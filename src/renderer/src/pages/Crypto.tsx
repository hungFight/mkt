            ...
            return (
              <div key={item.id}>
                <button
                  type="button"
                  className={`${
                    item.id === currentCoin.id ? 'bg-gray-100 dark:bg-[#192A3A]' : ''
                  } w-full flex items-center p-4 hover:bg-gray-100 dark:hover:bg-[#192A3A]`}
                  onClick={() => {
                    setCurrentCoin(item)
                ...
                >
                    ...
                    >
                      ...
                      <div className="flex items-center font-normal">
                        <svg
                          ...
                          className={item.isUp ? 'rotate-180' : ''}
                        >
                          <path
                  ...
                  <div className="flex-1 overflow-hidden">
                    <ReactApexChart
                      series={item.series}
                      options={item.isUp ? profiteChartOption : lossChartOption}
                      type="line"
                      height={45}
                    />
                  </div>
          ...
          <div className="md:flex items-center flex-wrap p-4 border-b border-[#ebedf2] dark:border-[#191e3a]">
            <div className="flex-1 flex items-start ltr:pr-4 rtl:pl-4">
              <button
                onClick={() => setIsShowCryptoMenu(!isShowCryptoMenu)}
                type="button"
                className="xl:hidden hover:text-primary block ltr:mr-5 rtl:ml-5"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <div className="font-semibold text-xs text-white-dark uppercase">
                    ({currentCoin.alias})
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  {!currentCoin.isUp && (
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="text-danger w-4 h-4 mb-px"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
            ...
            <ul className="ltr:md:ml-auto rtl:md:mr-auto grid grid-cols-2 sm:grid-cols-4 font-semibold sm:divide-x rtl:divide-x-reverse divide-[#ebedf2] dark:divide-[#253b5c] text-white-dark mt-5 sm:mt-0">
              <li className="px-4 py-1">
                Market Cap
                <span className="text-lg mt-1.5 block text-black dark:text-white-light">
