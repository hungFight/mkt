...
export const getCurrentPageURL = async (page: Page): Promise<string> => {
  return getPageProperty<string>(page, 'document.URL')
}

export const getDocumentContentOfPage = async (page: Page): Promise<string> => {
  return getPageProperty<string>(page, 'document.documentElement.innerText')
}
